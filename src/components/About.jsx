...
export default function About() {
	...
	return (
		<main className='relative'>
			<img src={Bird} alt='Bird flying over pond' className='absolute w-full' />
			<div className='container mx-auto relative p-10 lg:pt-20'>
				<section className=' rounded-lg lg:flex p-8'>
					...
					<div className='flex flex-col text-lg justify-center'>
						<h1 className='text-6xl text-blue-500 mb-4'>
							Howdy, my name is{' '}
							<span className='text-blue-200 italic'>{author.name}</span>
						</h1>
